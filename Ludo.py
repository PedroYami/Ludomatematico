...
perguntas =  [
    Pergunta("Qual é a forma geral de uma função afim?", ["a) y = ax^2 + b", "b) y = ax + b", "c) y = x^2 + a", "d) y = x - b"], 1, "grafico.webp"),
    Pergunta("O que é necessário para que uma função afim seja crescente?", ["O coeficiente angular (a) deve ser positivo.", "b) O coeficiente angular (a) deve ser negativo.", "c) O coeficiente linear (b) deve ser positivo."], 0, "grafico2.webp"),
    Pergunta("Qual é a imagem de uma função afim?", ["a) O conjunto de todos os valores de x.", "b) O conjunto de todos os valores de y.", "c) O conjunto de todos os valores de a e b.", "d) O conjunto de todos os valores de x e y."], 1, "grafico2.webp"),
    Pergunta("Qual é a equação do eixo de simetria de uma parábola com vértice (2,3)?", ["a) x = 2", "b) x = 3", "c) y = 2", "d) y = 3"], 0, "grafico2.webp"),
    Pergunta("Se uma função afim é decrescente, qual é a relação entre seus coeficientes?", ["a) a > 0 e b < 0", "b) a < 0 e b > 0", "c) a < 0 e b < 0", "d) a > 0 e b > 0"], 0, "grafico2.webp"),
    Pergunta("Qual é o ponto de interseção com o eixo x em uma função afim?", ["a) (0, a)", "b) (a, 0)", "c) (0, b)", "d) (b, 0)"], 0, "grafico2.webp"),
    Pergunta("Qual é o nome dado à linha reta que não se inclina em nenhum ponto?", ["a) Reta vertical", "b) Reta diagonal", "c) Reta horizontal", "d) Reta inclinada"], 0, "grafico2.webp"),
    Pergunta("Qual é a equação da reta paralela à reta y = 3x - 5?", ["a) y = -3x + 5", "b) y = 3x + 5", "c) y = 3x + 2", "d) y = -3x - 5"], 0, "grafico2.webp"),
    Pergunta("Qual é a forma geral de uma função quadrática?", ["a) y = ax + b", "b) y = ax^2 + b", "c) y = a^2x + b", "d) y = ax^2 + bx + c"], 0, "grafico2.webp"),
    Pergunta("O que é o vértice de uma parábola?", ["a) O ponto onde a parábola cruza o eixo x.", "b) O ponto mais alto da parábola.", "c) O ponto de interseção entre duas parábolas.", "d) O ponto médio da parábola."], 3, "grafico2.webp"),
    Pergunta("Como determinar se uma parábola se abre para cima ou para baixo?", ["a) Pelo valor de a na forma geral.", "b) Pelo valor de b na forma geral.", "c) Pelo valor de c na forma geral.", "d) Pelo valor de x na forma geral"], 0, "grafico2.webp"),
    ...
    Pergunta("O que são raízes (ou zeros) de uma função quadrática?", ["a) Os pontos onde a parábola cruza o eixo y.", "b) Os pontos de interseção da parábola com o eixo x.", "c) Os pontos de interseção da parábola com o eixo y.", "d) Os pontos mais altos e mais baixos da parábola."], 1, "grafico2.webp"),
    Pergunta("Qual é a equação do eixo de simetria de uma parábola com vértice (2,3)?", ["a) x = 2", "b) x = 3", "c) y = 2", "d) y = 3"], 0, "grafico2.webp"),
    Pergunta("Qual é a fórmula discriminante para determinar as raízes de uma função quadrática?", ["a) Δ = b^2 - 4ac", "b) Δ = 2ab - c", "c) Δ = 4a^2 - bc", "d) Δ = a^2 - 2bc"], 0, "grafico2.webp"),
]
